...
[![Codefactor](https://www.codefactor.io/repository/github/IlhamBismar/BotStickerXxX/badge)](https://www.codefactor.io/repository/github/IlhamBismar/BotStickerXxX)
<details>
 <summary>🥟 Help me!</summary>

 [Sweria](https://saweria.co/donate/IlhamBismar)
 
 [Trakteer](https://trakteer.id/Blue-emperor)
 
 [Paypal.me](https://paypal.me/IlhamBismar)
...
```bash
> git clone https://github.com/IlhamBismar/BotStickerXxX.git
> cd BotSticker
```
